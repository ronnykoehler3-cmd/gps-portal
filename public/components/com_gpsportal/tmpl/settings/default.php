...
<option value="license_plate" <?php echo (($this->settings->vehicle_display_mode ?? 'name') === 'license_plate') ? 'selected' : ''; ?>>Kennzeichen</option>
<option value="name_and_plate" <?php echo (($this->settings->vehicle_display_mode ?? 'name') === 'name_and_plate') ? 'selected' : ''; ?>>Fahrzeugname und Kennzeichen</option>
</select><br>
<small>Fehlt ein Kennzeichen, wird automatisch der Fahrzeugname angezeigt.</small>
</p>
